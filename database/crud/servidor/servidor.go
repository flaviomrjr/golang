...
func CriarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if erro != nil {
		w.Write([]byte("Erro ao obter valor inserido!"))
		return
	}
...
// Retorna os usuarios salvos no banco
...
// Retorna um usuario no banco
func BuscarUsuario(w http.ResponseWriter, r *http.Request) {
	parametros := mux.Vars(r)

	ID, erro := strconv.ParseUint(parametros["id"], 10, 32) // CONVERTE O ID PARA INTEIRO
	if erro != nil {
...
func AtualizarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	corpoRequisicao, erro := ioutil.ReadAll(r.Body) // LENDO A REQUEST
	if erro != nil {
		w.Write([]byte("Falha ao ler o corpo da requisicao!"))
		return
	}
	...
	var usuario usuario
	if erro = json.Unmarshal(corpoRequisicao, &usuario); erro != nil { // CONVERTENDO USUARIO PARA STRUCT
		w.Write([]byte("Erro ao converter o usuario para struct"))
		return
	}
...
func DeletarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if _, erro := statement.Exec(ID); erro != nil {
		w.Write([]byte("Erro ao deletar o usuarios!"))
		return
	}
